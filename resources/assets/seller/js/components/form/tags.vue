<template>
    <div class="form-tags">
        <Tag v-for="(item, index) in specs" :key="index" :name="index" closable @on-close="handleClose" type="border">{{item}}</Tag>
        <div class="form-tags-input">
            <Input ref="addTags" size="small" :placeholder="placeholder" search :enter-button="'添加' + placeholder"
