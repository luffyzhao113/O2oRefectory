<template>
    <i-drawer title="创建用户" :loading="loading">
        <Form ref="formCreate" :model="formCreate" :label-width="80" :rules="ruleCreate">
            ...
            <FormItem label="用户角色" prop="role_id">
                <m-select remote-url="admin/create" v-model="formCreate.role_id" placeholder="请选择用户角色"></m-select>
            </FormItem>
...
<script>
    import {Validator} from "../../../async-validator/role/admin/create"
