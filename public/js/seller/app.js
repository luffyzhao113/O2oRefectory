...
var IndexRouter = exports.IndexRouter = [{
    ...
    component: function component(resolve) {
        __webpack_require__.e/* require */(5).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(100)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    }
}, {
    path: 'profile',
    name: 'common.profile',
    meta: { title: '个人中心' },
    component: function component(resolve) {
        __webpack_require__.e/* require */(8).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(101)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    }
}, {
    path: 'sysconfig.role',
    ...
    meta: { title: '角色管理' },
    component: function component(resolve) {
        __webpack_require__.e/* require */(3).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(102)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    }
}, {
    ...
    meta: { title: '用户管理' },
    component: function component(resolve) {
        __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(103)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    }
}, {
    path: 'goods.model',
    name: 'goods.model',
    meta: { title: '商品属性' },
    component: function component(resolve) {
        __webpack_require__.e/* require */(4).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(240)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    }
}, {
    path: 'goods.goods',
    name: 'goods.goods',
    meta: { title: '商品列表' },
    component: function component(resolve) {
        __webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(105)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    }
}];
...
var commonRouter = exports.commonRouter = [{
  ...
  path: '500', name: 'common.500', meta: { title: '500-服务端错误' }, component: function component(resolve) {
    __webpack_require__.e/* require */(9).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(107)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  }
}, {
...
var _myHeader = __webpack_require__(42);

var _myHeader2 = _interopRequireDefault(_myHeader);

var _myRouterScroll = __webpack_require__(63);

var _myRouterScroll2 = _interopRequireDefault(_myRouterScroll);

var _myMenu = __webpack_require__(68);
...
var _myHeaderOwnspace = __webpack_require__(46);

var _myHeaderOwnspace2 = _interopRequireDefault(_myHeaderOwnspace);

var _myHeaderIcon = __webpack_require__(57);
