...
/* scopeId */
var __vue_scopeId__ = "data-v-b9398eea"
...
Component.options.__file = "resources\\assets\\seller\\js\\views\\goods\\recycle\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b9398eea", Component.options)
  } else {
    hotAPI.reload("data-v-b9398eea", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("4defbf97", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b9398eea\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b9398eea\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
    name: "index",
    components: { MyLists: _myLists2.default },
    ...
    methods: {
        search: function search() {
            ...
            this.$http.get("goods/recycle", { params: this.request(page) }).then(function (res) {
        ...
        restore: function restore(id) {
            ...
            this.$http.put("goods/" + id + "/restore").then(function () {
                _this3.search();
            }).catch(function (res) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b9398eea", module.exports)
  }
}
