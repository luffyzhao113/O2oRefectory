...
var _boxItem = __webpack_require__(235);
...
var _attribute = __webpack_require__(240);
  ...
  return _c(
    ...
    [
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("Button", {
                        attrs: { slot: "append", icon: "md-close" },
                        slot: "append"
                      })
                    ],
                    1
      ...
      _c(
        "Modal",
        {
          attrs: { title: "添加属性", transfer: "", width: 400 },
          on: { "on-ok": _vm.addItem },
          model: {
            value: _vm.modal,
            callback: function($$v) {
              _vm.modal = $$v
...
// module
exports.push([module.i, "\n.head[data-v-24e0a6ca]::after {\n  content: '';\n  display: table;\n  clear: both;\n}\n.head .title[data-v-24e0a6ca] {\n  float: left;\n}\n.head .add[data-v-24e0a6ca] {\n  float: right;\n  color: #2d8cf0;\n  cursor: pointer;\n}\n.form-item[data-v-24e0a6ca] {\n  margin-bottom: 5px;\n}\n", ""]);
