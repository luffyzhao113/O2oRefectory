...
var Validator = exports.Validator = function Validator(data) {
    return {
        ...
        type: [{ required: true, type: 'number', message: '类型必须填写', trigger: 'change' }],
        input: [{ required: true, type: 'string', message: '输入框必须填写', trigger: 'change' }]
    };
};
...
var _tags = __webpack_require__(260);
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-0835b80a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("cd55bb18", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0835b80a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./update.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0835b80a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./update.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            _this.loading = true;
            _this.$http.get("attribute/" + _this.data.id + "/edit").then(function (res) {
    ...
    methods: {
        ...
        inputChange: function inputChange(val) {
            if (val === 'text') this.formUpdate.values = [{ name: '' }];
        }
    }
};
...
var render = function() {
  ...
  return _c(
    "component-modal",
    { attrs: { title: "修改商品属性&规格", loading: _vm.loading } },
    [
      _c(
        "Form",
        {
        ...
        [
                    ...
                    [
                      _c(
                        "i-select",
                        {
                          ...
                          model: {
                            value: _vm.formUpdate.type,
                            callback: function($$v) {
                              _vm.$set(_vm.formUpdate, "type", $$v)
                            },
                            expression: "formUpdate.type"
                          }
                        },
                        [
              ...
              _vm.formUpdate.type === 1
                ? _c(
                    ...
                    [
                      _c(
                        "FormItem",
                        { attrs: { label: "输入框类型", prop: "input" } },
                        [
                          _c(
                            "i-select",
                            {
                              attrs: { transfer: "" },
                              on: { "on-change": _vm.inputChange },
                              model: {
                                value: _vm.formUpdate.input,
                                callback: function($$v) {
                                  _vm.$set(_vm.formUpdate, "input", $$v)
                                },
                                expression: "formUpdate.input"
                              }
                            },
                            [
                              _c("i-option", { attrs: { value: "text" } }, [
                                _vm._v("文本框")
                              ]),
                              _vm._v(" "),
                              _c("i-option", { attrs: { value: "select" } }, [
                                _vm._v("选择框")
                              ])
                            ],
                            1
          ...
          _vm._l(_vm.formUpdate.values, function(item, index) {
            return _vm.formUpdate.input === "select"
              ? _c(
                  "FormItem",
                  {
                    key: index,
                    attrs: {
                      ...
                      rules: { required: true, message: "属性&规格值必须填写" }
                    }
                  },
                  [
                    _c(
        ...
        [
          _c(
            "Button",
            {
              on: {
                click: function($event) {
                  _vm.updateSubmit("formUpdate", "attribute/" + _vm.data.id)
                }
              }
            },
            [_vm._v("修改")]
...
var _emitter = __webpack_require__(267);
